            ...
            <div class="form-control mb-4">
                <form method="post" enctype="multipart/form-data" action="/admin/create" id="marca-form">
                    ...
                    <p>
                        ...
                        <input type="file" data-validation="required" accept="image/*" class="form-control" id="imagen_producto" name="imagen_producto">
                    </p>
                    <p>
                        <label for="ficha_producto">Ficha Técnica del producto</label>
                        <input type="file" data-validation="required" accept="application/pdf" class="form-control" id="ficha_producto" name="ficha_producto">
                    </p>
                    <p>
                        <label for="descripcion_producto">Descripción del producto</label>
                        <textarea type="text" data-validation="required" class="form-control" id="descripcion_producto" name="descripcion_producto"></textarea>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <input type="text" data-validation="required" class="form-control" id="codigo_producto" name="codigo_producto">
                    </p>
