                ...
                <div class="form-control">
                    <form method="POST" enctype="multipart/form-data" action="/admin/create-type" id="marca-form">
                        <p><label for="nombre-tipo">Nombre del tipo de producto:</label>
                            <input type="text" class="form-control" name="nombre-tipo" id="nombre-tipo"></p>
                        <p><label for="codigo-tipo">Código del tipo de producto</label>
                            <input type="text" class="form-control" name="codigo-tipo" id="codigo-tipo"></p>
                        <p><label for="intro-marca">Descripción</label>
                            <input type="text" class="form-control" name="intro-tipo" id="intro-tipo"></p>
