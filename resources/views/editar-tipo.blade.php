        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <h1 class="text-uppercase">
                    <strong>Ingrese su nuevo tipo de producto</strong>
                </h1>
            </div>
        </div>
    </div>
                ...
                <div class="form-control">
                    <form method="POST" enctype="multipart/form-data" action="/admin/edit-type/{{$tipo->id}}" id="marca-form">
                        <p><label for="nombre-tipo">Nombre del tipo de producto:</label>
                            <input type="text" class="form-control" value="{{$tipo->nombre}}" name="nombre-tipo" id="nombre-tipo"></p>
                        <p><label for="codigo-tipo">Código del tipo de producto</label>
                            <input type="text" class="form-control" value="{{$tipo->codigo}}" name="codigo-tipo" id="codigo-tipo"></p>
                        <p><label for="intro-marca">Descripción</label>
                            <input type="text" class="form-control" value="{{$tipo->introducción}}" name="intro-tipo" id="intro-tipo"></p>
