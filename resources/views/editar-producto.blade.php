...
<div class="container-fluid">
    ...
    <form class="ml-4 mt-4" enctype="multipart/form-data" action="/admin/editar/{{$producto->id}}" method="POST">
        <div class="form-group row">
            ...
            <div class="col-xs-9">
                <input type="text" class="form-control" value="{{$producto->nombre}}" id="nombre_producto" name="nombre_producto">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <!--<div class="col-xs-9">
                <input type="text" class="form-control" value="{{$producto->marca->nombre}}" id="marca_producto" name="marca_producto">
            </div>-->
            <div class="col-xs-9">
        ...
        <div class="form-group row">
            ...
            <!--<div class="col-xs-9">
                <input type="text" class="form-control" value="{{$producto->tipo->nombre}}" id="tipo_producto" name="tipo_producto">
            </div>-->
            <div class="col-xs-9">
                <!--try to use this element for populate with brand name and types product name-->
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-9">
                <input type="text" class="form-control" value="{{$producto->codigo}}" id="codigo_producto" name="codigo_producto">
            </div>
        </div>
        <div class="form-group row">
