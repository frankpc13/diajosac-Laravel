...
<head>
    ...
    <title>Normativa de cascos de protección - DIAJO SAC</title>
...
<div class="container-fluid p-5">
    ...
    <p>
        Tipo de aislamiento eléctrico Clase G (General)
    <li class="ml-5">Destinadas a reducir el peligro a la exposición de contacto con los conductores de baja tensión</li>
    </p>
